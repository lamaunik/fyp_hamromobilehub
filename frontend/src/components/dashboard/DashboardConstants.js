...
export const P = {
  ...
  muted:"#6b99b5", mistBg:"#f0f6f9", red:"#ef4444",
...
export const CSS = `
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  @keyframes pulse{0%,100%{box-shadow:0 0 0 0 rgba(1,138,190,.5)}50%{box-shadow:0 0 0 8px rgba(1,138,190,0)}}
  ...
  .btn:hover{transform:translateY(-2px)!important;box-shadow:0 8px 24px rgba(1,138,190,.25)!important}
  .btn:active{transform:translateY(0)!important}
  .card{transition:all .2s cubic-bezier(.4,0,.2,1)!important}
  .card:hover{transform:translateY(-4px)!important;box-shadow:0 12px 32px rgba(1,138,190,.15)!important;border-color:#97CADB!important}
  .nav-item{transition:all .15s!important}
  .nav-item:hover{background:#f0f6f9!important;color:#001B48!important;transform:translateX(3px)!important}
  .icon-btn{transition:all .17s!important}
  .icon-btn:hover{background:#D6E8EE!important;border-color:#97CADB!important;transform:scale(1.07)!important}
  .icon-btn:active{transform:scale(.93)!important}
  input:focus,textarea:focus,select:focus{outline:none!important}
  ::-webkit-scrollbar{width:5px;height:5px}
  ::-webkit-scrollbar-track{background:#f0f6f9}
  ::-webkit-scrollbar-thumb{background:#97CADB;border-radius:99px}
  ::-webkit-scrollbar-thumb:hover{background:#018ABE}
`;
...
export const BADGE_COLORS = {
  ...
  Deal: {bg:"rgba(1,138,190,.1)",  border:"rgba(1,138,190,.25)",  text:"#018ABE"},
};

export const STATUS_COLORS = {
  Delivered: {bg:"rgba(34,197,94,.1)",  text:"#16a34a",  border:"rgba(34,197,94,.3)"},
  Shipped:   {bg:"rgba(1,138,190,.1)",  text:"#018ABE",  border:"rgba(1,138,190,.3)"},
