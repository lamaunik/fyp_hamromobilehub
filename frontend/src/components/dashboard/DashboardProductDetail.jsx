        ...
        <div style={{ flex: "1 1 400px", display: "flex", flexDirection: "column", py: 10 }}>
          ...
          {product.storage && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              <span style={{ 
                background: P.mistBg, color: P.ocean, fontSize: 12, fontWeight: 800, padding: "6px 14px", 
                borderRadius: 12, border: `1.5px solid ${P.mist}`, display: "flex", alignItems: "center", gap: 6 
              }}>
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path d="M12 11V16M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z" strokeLinecap="round" strokeLinejoin="round"/></svg>
