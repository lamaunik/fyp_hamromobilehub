...
export default function DashboardWishlist({ wishlist, toggleWish, addToCart, viewProduct, setTab, products }) {
  ...
  if (items.length === 0) return (
    <div className="page" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "70vh", padding: 40, textAlign: "center", fontFamily: P.font }}>
      <div className="float" style={{ width: 100, height: 100, borderRadius: 28, background: `linear-gradient(135deg,${P.mist},${P.sky})`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 24, color: P.royal, boxShadow: "0 12px 36px rgba(40, 43, 74, .16)" }}>
        {Icon.wishlist}
      </div>
  ...
  return (
    <div className="page" style={{ padding: "28px 32px", fontFamily: P.font }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
        ...
        <Btn cls="btn" onClick={() => items.forEach((p) => addToCart(p))} style={{ padding: "10px 22px", background: `linear-gradient(135deg,${P.royal},${P.ocean})`, color: P.white, fontSize: 13, fontWeight: 700, borderRadius: 12, boxShadow: "0 4px 14px rgba(40, 43, 74, .28)" }}>
          Add All to Cart
        </Btn>
      </div>
