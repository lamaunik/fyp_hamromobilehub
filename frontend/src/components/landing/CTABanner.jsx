...
export default function CTABanner() {
  return (
    <section style={{ background:P.navy,padding:"96px 24px",position:"relative",overflow:"hidden",fontFamily:P.font }}>
      <div style={{ position:"absolute",top:0,left:"25%",width:384,height:384,borderRadius:"50%",background:"rgba(40, 43, 74, 0.12)",filter:"blur(80px)" }}/>
      <div style={{ position:"absolute",bottom:0,right:"25%",width:384,height:384,borderRadius:"50%",background:"rgba(212, 210, 195, 0.08)",filter:"blur(80px)" }}/>
      ...
      <div style={{ maxWidth:1280,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"center",position:"relative" }}>
        <div>
          <span style={{ display:"inline-block",background:"rgba(40, 43, 74, 0.18)",color:P.sky,fontSize:11,fontWeight:800,letterSpacing:"0.1em",textTransform:"uppercase",padding:"6px 16px",borderRadius:999,border:"1px solid rgba(40, 43, 74, 0.35)",marginBottom:24 }}>
            Start Today
          </span>
          ...
          <p style={{ color:"rgba(212, 210, 195, 0.65)",fontSize:16,lineHeight:1.7,margin:"0 0 36px",maxWidth:440 }}>
          ...
          <div style={{ display:"flex",gap:16,flexWrap:"wrap" }}>
            <Link to="/signup" style={{ display:"inline-flex",alignItems:"center",gap:8,background:`linear-gradient(135deg,${P.ocean},#0aa8e0)`,color:P.white,fontWeight:700,fontSize:15,padding:"14px 32px",borderRadius:999,textDecoration:"none",boxShadow:"0 8px 28px rgba(40, 43, 74, 0.4)",transition:"transform 0.15s" }}
        ...
        <div style={{ display:"flex",justifyContent:"center",alignItems:"center" }}>
          <div style={{ position:"relative" }}>
            <div style={{ position:"absolute",top:-32,left:"50%",transform:"translateX(-50%)",display:"flex",flexDirection:"column",alignItems:"center",zIndex:10 }}>
              <div style={{ width:48,height:48,borderRadius:"50%",background:`linear-gradient(135deg,${P.royal},${P.ocean})`,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 8px 24px rgba(40, 43, 74, 0.4)" }}>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12,marginTop:48 }}>
              {[P.navy,P.royal,P.ocean,P.royal,P.ocean,P.sky].map((col,i)=>(
                <div key={i} style={{ width:80,height:80,borderRadius:14,background:`linear-gradient(135deg,${col},${col}cc)`,border:`2px solid rgba(229, 227, 213, 0.25)`,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 8px 24px rgba(40, 43, 74, 0.3)",transform:`rotate(${(i%3-1)*3}deg)` }}>
                  <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="rgba(229, 227, 213, 0.7)" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                </div>
              ))}
            </div>
          </div>
