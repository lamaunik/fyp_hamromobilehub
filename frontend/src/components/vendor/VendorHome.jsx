...
const PRODUCTS = [
  { name: "iPhone 14 Pro",       price: "$899", badge: "Hot",  badgeColor: "bg-red-500"   },
  { name: "Samsung S23",         price: "$749", badge: "Sale", badgeColor: "bg-orange-500"},
  { name: "Google Pixel 8",      price: "$599", badge: "New",  badgeColor: "bg-green-500" },
  { name: "MacBook Air M2",      price: "$1099",badge: "Deal", badgeColor: "bg-blue-500"  },
  { name: "OnePlus 12",          price: "$549", badge: "Hot",  badgeColor: "bg-red-500"   },
];
...
export default function VendorHome() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-gray-800 font-bold text-base">Featured Products</h3>
          <button className="text-blue-600 text-sm font-semibold hover:text-blue-800 transition-colors">View All</button>
        </div>
          ...
          {PRODUCTS.map((p, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <span className={`absolute top-2 left-2 ${p.badgeColor} text-white text-[10px] font-black px-2 py-0.5 rounded-md`}>
                  {p.badge}
                </span>
              </div>
              <div className="p-3">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "My Listings",   value: "0",   color: "bg-blue-50",   text: "text-blue-600"  },
          { label: "Orders",        value: "0",   color: "bg-orange-50", text: "text-orange-600"},
          { label: "Revenue",       value: "$0",  color: "bg-green-50",  text: "text-green-600" },
