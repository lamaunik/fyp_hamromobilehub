...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center px-6 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <div className="w-4 h-4 rounded border border-white/20 bg-white/5 flex items-center justify-center">
                  <div className="w-2 h-2 rounded-sm bg-blue-400 opacity-0" />
                </div>
                <span className="text-blue-200/60 text-xs font-semibold">Remember me</span>
              </label>
              <a href="#" className="text-cyan-400 text-xs font-bold hover:text-cyan-300 transition-colors">
                Forgot password?
              </a>
            </div>
